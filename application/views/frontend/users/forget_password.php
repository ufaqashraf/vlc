    ...
    <div class="signup-container">
        <div class="signup-wrap">
            <div class="inner-signup">
                ...
                <?php endif; ?>
                <form class="needs-validation" action="<?php echo base_url('users/user_password_reset'); ?>" method="post" novalidate>
                    <fieldset>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="textField"><label class="sidebarTitle" for="validationCustom03">Enter your Email</label>
                                    <input id="validationCustom03" type="email" name="user_email" id="user_email" class="form-control" placeholder="Type Email Here">
