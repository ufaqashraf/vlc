				...
				<div id="core-main-listing">
					<form class="buyingSubTbl-container" method="post" action="#">
						<table class="table table-hover buyingSubTbl">
							<tr>
								<th colspan=4><?php echo $buying_leads['cat_parent']->name; ?><span class=pull-right>Total <?php echo count($buying_leads['listings']); ?></span></th>
							</tr>
							<tr class="bg_gr">
								<td> &nbsp; </td>
								<td>Date </td>
							...
							<?php if (! empty($buying_leads)): ?>
								<?php foreach ($buying_leads['listings'] as $listing):
                                    ?>
									<tr>
