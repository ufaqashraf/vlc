	...
	<div class="container-fluid mainWrapper listingMain ">
		<div class="row">
			...
			<div class="post_form_wrapper">
				...
				<div class="ad_title"><h3>Post Free AD on VolgoPoint</h3></div>
				...
				<form action="<?php echo base_url('ad-post'); ?>" method="POST" enctype="multipart/form-data" id="post-form">
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="listing_type">Add Type</label>
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputTitle">Add Title</label>
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="input_description">Add Description</label>
					...
					<button type="submit" class="btn btn-large btn-sub">Save & Submit AD</button>
				</form>
