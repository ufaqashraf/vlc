	...
	<div class="container-fluid mainWrapper listingMain selling_page">
		<div class="row">
			...
			<div class="post_form_wrapper">
				...
				<div class="ad_title"><h3>Post Seller Lead on VolgoPoint</h3></div>
				...
				<form action="<?php echo base_url('add-seller-lead'); ?>" method="POST" enctype="multipart/form-data">
					<div class="form-row">
					...
					<button type="submit" class="btn btn-large btn-sub">Submit Seller Lead</button>
				</form>
