...
<section class="main-section">
    ...
    foreach ($listing_detail['metas'] as $metas) :
		...
		if ($metas->meta_key == 'productage') {
			$productage = $metas->meta_value;
		}
        if ($metas->meta_key == 'phone') {
            $phone = $metas->meta_value;
        }
		if ($metas->meta_key == 'usage') {
			$usage = $metas->meta_value;
		}
							...
							<ul class="adListing">
								<li>
									<div class="innerBox">
										...
										<div class="adInfo">
											<h4>Posted Date</h4>
											<p>
												<?php $date2 = new DateTime($listing_data->created_at);
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="age2-icon">Age</span></div>
										<div class="adInfo">
											<h4>Age</h4>
											<p>
												<?php if (isset($productage) && !empty($productage)) {
													 echo $productage;
													 unset($productage);
												}else{
												    echo 'N/A';
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="usage-icon">Usage</span></div>
										<div class="adInfo">
											<h4>Usage</h4>
											<p>
												<?php if (isset($usage) && !empty($usage)) {
                                                     echo $usage;
													 unset($usage);
												}else{
												    echo 'N/A';
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="condition-icon">Condition</span></div>
										<div class="adInfo">
											<h4>Condition</h4>
											<p>
