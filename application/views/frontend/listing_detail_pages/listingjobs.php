...
<?php
    ...
    if ($metas->meta_key === 'salary') {
        $salary = $metas->meta_value;
    }
    if ($metas->meta_key == 'phone') {
        $phone = $metas->meta_value;
    }
    if ($metas->meta_key === 'minimumexperience') {
        $minimumexperience = $metas->meta_value;
    }
    if ($metas->meta_key === 'min-education') {
        $mineducation = $metas->meta_value;
    }
    if ($metas->meta_key === 'listed') {
        $listed = $metas->meta_value;
    }
    if ($metas->meta_key === 'career') {
        $career = $metas->meta_value;
    }
        ...
        <div class="row">
            <div class="col-md-4 col-lg-3 cbg">
                <div class="side-bar-left">
                    ...
                    <div class="post_map">
                        <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2406.2340796678136!2d74.25984527008465!3d31.47114279947925!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3919022c4aea8931%3A0xb0d8d78296b500e4!2sMughal+Eye+Hospital!5e0!3m2!1sen!2s!4v1552559477941"
                            ...
                            <ul class="adListing">
                                ...
                                <li>
                                    <div class="innerBox">
                                        ...
                                        <div class="circleBox"><span class="employment-icon">Employment Type</span></div>
                                        <div class="adInfo">
                                ...
                                <li>
                                    <div class="innerBox">
                                        ...
                                        <div class="circleBox"><span class="salary-icon">Monthly Salary</span></div>
                                        <div class="adInfo">

                                            <h4>Monthly Salary</h4>
                                            <p><?php if (isset($salary) && $salary !== '') {
                                                    echo $salary;
                                                } else {
                                                    echo 'N/A';
                                                } ?></p>
                                ...
                                <li>
                                    <div class="innerBox">
                                        ...
                                        <div class="circleBox"><span class="experince-icon">Min Experience</span></div>
                                        <div class="adInfo">
                                            <h4>Min Experience</h4>
                                            <p><?php if (isset($minimumexperience) && $minimumexperience !== '') {
                                                    echo $minimumexperience;
                                                } else {
                                                    echo 'N/A';
                                                } ?></p>
                                        </div>
                                ...
                                <li>
                                    <div class="innerBox">
                                        ...
                                        <div class="circleBox"><span class="edu-icon">Min Education</span></div>
                                        <div class="adInfo">
                                            <h4>Min Education</h4>
                                            <p><?php if (isset($mineducation) && $mineducation !== '') {
                                                    echo $mineducation;
                                                } else {
                                                    echo 'N/A';
                                                } ?></p>
                                ...
                                <li>
                                    <div class="innerBox">
                                        ...
                                        <div class="circleBox"><span class="listed-icon">Listed By</span></div>
                                        <div class="adInfo">
                                            <h4>Listed By</h4>
                                            <p><?php if (isset($listed) && $listed !== '') {
                                                    echo $listed;
                                                } else {
                                                    echo 'N/A';
                                                } ?></p>
                                ...
                                <li>
                                    <div class="innerBox">
                                        ...
                                        <div class="circleBox"><span class="career-icon">Career Level</span></div>
                                        <div class="adInfo">
                                            <h4>Career Level</h4>
                                            <p><?php if (isset($career) && $career !== '') {
                                                    echo $career;
                                                } else {
                                                    echo 'N/A';
                                                } ?></p>
                                ...
                                <li>
                                    <div class="innerBox">
                                        ...
                                        <div class="circleBox"><span class="position-icon">Total Positions</span></div>
                                        <div class="adInfo">
                                            <h4>Total Positions</h4>
                                            <p><?php if (isset($total_positions) && $total_positions !== '') {
