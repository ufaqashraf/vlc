				...
				<div class="detail-section">
					...
					<div class="inner-detailBox">
							...
							<ul class="adListing">
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="kilometer-icon">KILOMETERS</span></div>
										<div class="adInfo">
											<h4>KILOMETERS</h4>
											<p><?php if (isset($kilometers) && $kilometers !== '') {
													echo $kilometers;
												} else {
													echo 'N/A';
												} ?></p>
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="color-icon">color</span></div>
										<div class="adInfo">
											<h4>COLOR</h4>
											<p><?php if (isset($color) && $color !== '') {
													echo $color;
												} else {
													echo 'N/A';
												} ?></p>
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="body-icon">BODY TYPE</span></div>
										<div class="adInfo">
											<h4>BODY TYPE</h4>
											<p>Sedan</p>
										</div>
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="doors-icon">doors</span></div>
										<div class="adInfo">
											<h4>DOORS</h4>
											<p><?php if (isset($doors) && $doors !== '') {
													echo $doors;
												} else {
													echo 'N/A';
												} ?></p>
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="trans-icon">TRANSMISSION</span></div>
										<div class="adInfo">
											<h4>TRANSMISSION</h4>
											<p><?php if (isset($transmission) && $transmission !== '') {
													echo $transmission;
												} else {
													echo 'N/A';
												} ?></p>
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="warranty-icon">WARRANTY</span></div>
										<div class="adInfo">
											<h4>WARRANTY</h4>
											<p><?php if (isset($warranty) && $warranty !== '') {
													echo $warranty;
												} else {
													echo 'N/A';
												} ?></p>
								...
								<li>
									<div class="innerBox">
										...
										<div class="circleBox"><span class="gas-icon">SPECS</span></div>
										<div class="adInfo">
											<h4>FUEL TYPE</h4>
											<p><?php if (isset($fueltype) && $fueltype !== '') {
													echo $fueltype;
												} else {
													echo 'N/A';
												} ?></p>
						...
						<div class="conditionSection">
							...
							<ul>
								<li>
									<div class="col-a"><p><i class="icon-body">body</i> Body Condition</p></div>
									<div class="col-b"><p><?php if (isset($bodycondition) && $bodycondition !== '') {
												echo $bodycondition;
											} else {
												echo 'N/A';
											} ?></p></div>
								...
								<li>
									<div class="col-a"><p><i class="icon-mech">Mechanical</i> Mechanical Condition</p>
									</div>
									<div class="col-b">
										<p><?php if (isset($mechanicalcondition) && $mechanicalcondition !== '') {
												echo $mechanicalcondition;
											} else {
												echo 'N/A';
											} ?></p></div>
								</li>
								<li>
									<div class="col-a"><p><i class="icon-trim">Trim</i> Trim</p></div>
									<div class="col-b"><p>730li Exclusive</p></div>
								</li>
								<li>
									<div class="col-a"><p><i class="icon-cyl">Cylinders</i> No. Of Cylinders</p></div>
									<div class="col-b"><p><?php if (isset($cylinder) && $cylinder !== '') {
												echo $cylinder;
											} else {
												echo 'N/A';
											} ?></p></div>
								...
								<li>
									<div class="col-a"><p><i class="icon-seller">Seller</i> Seller Type</p></div>
									<div class="col-b"><p><?php if (isset($listedby) && $listedby !== '') {
												echo $listedby;
											} else {
												echo 'N/A';
											} ?></p></div>
								...
								<li>
									<div class="col-a"><p><i class="icon-extras">Extras</i> Extras</p></div>
									<div class="col-b"><p><?php if (isset($extra_data) && $extra_data !== '') {
												echo $extra_data;
											} else {
												echo 'N/A';
											} ?></p></div>
